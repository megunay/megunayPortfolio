  ...
  return (
    <div className="flex">
      ...
      <div className="ml-[80px] w-[calc(100%-80px)] w-full">
        ...
        <section id="about" className="h-screen flex items-center justify-center bg-black text-white px-10 md:px-40">
          <div className="text-left">
            <h2 className="text-4xl font-bold text-slate-400 text-center">About Me</h2>
            <p className="text-lg mt-4 text-gray-300">
              Hi, I’m <span className="text-blue-400 font-bold">Erkan</span>! I’m a passionate Full-Stack Developer with a background in 
            ...
            <p className="text-lg mt-4 text-gray-300">
              I’m a hardworking and enthusiastic developer who enjoys tackling challenges and staying ahead in the 
              ever-evolving tech world. When I'm not coding, I spend quality time with my lovely wife and baby boy, 
              who motivate me every day. Let’s connect and build something amazing together! 🚀
            </p>
            ...
            <div className="mt-4 text-gray-300">
              ...
              <p><span className="text-green-300 font-semibold">2020-2022:</span> Hacettepe University (Turkey) - Master’s in Software Engineering (Incomplete)</p>
            </div>
